...
class MessageLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ["phone", "message", "message_id", "external_system_response"]
    ...
    def mark_as_pending(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{updated} mensagem(s) marcada(s) como pendente(s) para reencaminhamento.",
        )
    ...
    def retry_forwarding(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{updated} mensagem(s) marcada(s) para nova tentativa de reencaminhamento.",
        )
